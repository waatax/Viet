...
export const hanVietRoots = [
  ...
  },
  {
    han: '食 (Shí) / 實 (Shí)',
    root: 'Thực',
    meaningZh: '飲食、食物 (食)；真實、實踐 (實)',
    meaningEn: 'Eat, Food (食) / Real, Practice (實)',
    phonologyNoteZh: '中古入聲 -k 尾，對應越語 -c 尾 (Thực)。「食」與「實」在越語中同音。',
    compounds: [
      { viet: 'Thực phẩm', zh: '食品 (食)', en: 'Food products' },
      { viet: 'Ẩm thực', zh: '飲食文化 / 美食 (食)', en: 'Cuisine' },
      { viet: 'Thực đơn', zh: '食單 / 菜單 (食)', en: 'Menu' },
      { viet: 'Thực tế', zh: '實際 (實)', en: 'Realistic / Practical' },
      { viet: 'Thực hiện', zh: '實行 / 實現 (實)', en: 'To implement' }
    ]
  },
  {
    han: '品 (Pǐn)',
  ...
  },
  {
    han: '財 (Cái) / 材 (Cái)',
    root: 'Tài',
    meaningZh: '財務、財富 (財)；材料、才能 (材/才)',
    meaningEn: 'Finance, Wealth (財) / Material, Talent (材/才)',
    compounds: [
      { viet: 'Tài chính', zh: '財務 / 金融 (財)', en: 'Finance' },
      { viet: 'Tài sản', zh: '財產 / 資產 (財)', en: 'Assets' },
      { viet: 'Tài liệu', zh: '材料 / 文件資料 (材)', en: 'Documents' },
      { viet: 'Tài năng', zh: '才能 / 天賦 (才)', en: 'Talent' },
      { viet: 'Tài xế', zh: '司機 / 駕駛 (載/駛)', en: 'Driver' }
    ]
  },
  {
    han: '技 (Jì)',
  ...
  },
  {
    han: '自 (Zì)',
    root: 'Tự',
    meaningZh: '自由、自動、自己、自信',
    meaningEn: 'Self, Auto, Free',
    compounds: [
      { viet: 'Tự do', zh: '自由', en: 'Freedom / Liberty' },
      { viet: 'Tự động', zh: '自動', en: 'Automatic' },
      { viet: 'Tự tin', zh: '自信', en: 'Confident' },
      { viet: 'Tự nhiên', zh: '自然', en: 'Natural' },
      { viet: 'Tự lập', zh: '自立 / 獨立', en: 'Independent' }
    ]
  },
  {
    han: '發 (Fā)',
    root: 'Phát',
    meaningZh: '發展、發明、發音、發表',
    meaningEn: 'Develop, Emit, Pronounce',
    compounds: [
      { viet: 'Phát triển', zh: '發展', en: 'Develop / Growth' },
      { viet: 'Phát âm', zh: '發音', en: 'Pronunciation' },
      { viet: 'Phát minh', zh: '發明', en: 'Invention' },
      { viet: 'Phát biểu', zh: '發表 / 發言', en: 'Statement / Speech' },
      { viet: 'Xuất phát', zh: '出發', en: 'Depart / Set off' }
    ]
  },
  {
    han: '保 (Bǎo) / 寶 (Bǎo)',
    root: 'Bảo',
    meaningZh: '保護、保險 (保)；珍寶、寶藏 (寶)',
    meaningEn: 'Protect, Insurance (保) / Treasure (寶)',
    compounds: [
      { viet: 'Bảo hiểm', zh: '保險 (保)', en: 'Insurance' },
      { viet: 'Bảo đảm', zh: '保證 / 擔保 (保)', en: 'Guarantee' },
      { viet: 'Bảo vệ', zh: '保全 / 保護 (保)', en: 'Security / Protect' },
...
export const flashcardsDeck = [
  ...
  { id: 2, viet: 'Cảm ơn', zh: '感謝 / 謝謝', en: 'Thank you', hanViet: '感恩 (Cảm ơn · 漢越詞)', category: '問候與禮貌', example: 'Cảm ơn bạn rất nhiều vì đã giúp đỡ.' },
  { id: 3, viet: 'Quốc tế', zh: '國際', en: 'International', hanViet: '國際 (Quốc tế · 漢越詞)', category: '漢越核心', example: 'Sân bay quốc tế Nội Bài ở Hà Nội.' },
  ...
  { id: 6, viet: 'Công ty', zh: '公司 / 企業', en: 'Company / Corporation', hanViet: '公司 (Công ty · 漢越詞)', category: '商務職場', example: 'Công ty chúng tôi có trụ sở ở Quận 1.' },
  { id: 7, viet: 'Hợp đồng', zh: '合約 / 契約', en: 'Contract / Agreement', hanViet: '合同 (Hợp đồng · 漢越詞)', category: '商務職場', example: 'Hai bên đã chính thức ký kết hợp đồng.' },
  { id: 8, viet: 'Bệnh viện', zh: '醫院', en: 'Hospital', hanViet: '病院 (Bệnh viện · 漢越詞)', category: '醫療健康', example: 'Tôi cần đi đến bệnh viện khám sức khỏe.' },
  { id: 9, viet: 'Sân bay', zh: '機場 / 飛機場', en: 'Airport', hanViet: '飛機場 (Phi trường · 漢越詞)', category: '交通出行', example: 'Đón đối tác ở sân bay Tân Sơn Nhất.' },
  { id: 10, viet: 'Kinh tế', zh: '經濟', en: 'Economy', hanViet: '經濟 (Kinh tế · 漢越詞)', category: '漢越核心', example: 'Kinh tế Việt Nam đang phát triển mạnh mẽ.' },
  { id: 11, viet: 'Đắt quá', zh: '太貴了 / 算便宜點', en: 'Too expensive', hanViet: '', category: '購物殺價', example: 'Cái áo này đắt quá, bớt cho em một chút nhé!' },
  { id: 12, viet: 'Khách sạn', zh: '飯店 / 旅館', en: 'Hotel', hanViet: '客棧 (Khách sạn · 漢越詞)', category: '飯店住宿', example: 'Chúng tôi đặt phòng khách sạn năm sao 3 đêm.' },
  ...
  { id: 19, viet: 'Tôi là người Đài Loan', zh: '我是台灣人', en: 'I am Taiwanese', hanViet: 'Đài Loan (台灣 · 漢越詞)', category: '社交日常', example: 'Tôi là người Đài Loan sang Việt Nam du lịch.' },
  { id: 20, viet: 'Bạn khỏe không?', zh: '你身體好嗎？近況如何？', en: 'How are you?', hanViet: '', category: '社交日常', example: 'Dạo này anh chị có khỏe không?' },
  ...
  { id: 27, viet: 'Trà đá vỉa hè', zh: '街頭路邊冰茶', en: 'Street Iced Tea', hanViet: 'Trà (茶 · 漢越詞)', category: '餐飲美食', example: 'Ngồi uống trà đá vỉa hè ngắm phố phường.' },
  ...
  { id: 33, viet: 'Tôi ăn chay', zh: '我吃素', en: 'I am vegetarian', hanViet: 'Chay (齋 · 漢越古音)', category: '餐飲美食', example: 'Quán này có món ăn chay không ạ?' },
  { id: 34, viet: 'Thực đơn', zh: '菜單 / 食單', en: 'Menu', hanViet: '食單 (Thực đơn · 漢越詞)', category: '餐飲美食', example: 'Cho tôi xem thực đơn đồ uống hôm nay.' },
  { id: 35, viet: 'Hải sản tươi sống', zh: '新鮮活海鮮', en: 'Fresh Seafood', hanViet: '海產 (Hải sản · 漢越詞)', category: '餐飲美食', example: 'Quán này nổi tiếng với hải sản tươi sống giá rẻ.' },
  { id: 36, viet: 'Giảm giá một chút', zh: '算便宜一點 / 打折', en: 'Give a discount', hanViet: '減價 (Giảm giá · 漢越詞)', category: '購物殺價', example: 'Mua nhiều có được giảm giá một chút không cô?' },
  ...
  { id: 40, viet: 'Mua hai tặng một', zh: '買二送一', en: 'Buy 2 get 1 free', hanViet: 'Tặng (贈 · 漢越詞)', category: '購物殺價', example: 'Chương trình khuyến mãi mua hai tặng một.' },
  ...
  { id: 42, viet: 'Hàng chất lượng cao', zh: '高品質商品', en: 'High quality goods', hanViet: 'Chất lượng (質量/品質 · 漢越詞)', category: '購物殺價', example: 'Cà phê này là hàng chất lượng cao xuất khẩu.' },
  { id: 43, viet: 'Xuất xứ ở đâu?', zh: '產地來源在哪裡？', en: 'Where is it made?', hanViet: 'Xuất xứ (出處 · 漢越詞)', category: '購物殺價', example: 'Sản phẩm này có xuất xứ từ Đà Lạt.' },
  ...
  { id: 49, viet: 'Bật đồng hồ tính tiền', zh: '請按表跳表計費', en: 'Please turn on the meter', hanViet: 'Đồng hồ (銅壺/鐘錶 · 漢越詞)', category: '交通出行', example: 'Làm ơn bật đồng hồ tính tiền taxi giúp tôi.' },
  ...
  { id: 51, viet: 'Ga tàu hỏa', zh: '火車站', en: 'Train station', hanViet: 'Tàu hỏa (火車 · 漢越詞)', category: '交通出行', example: 'Ga tàu hỏa Hà Nội nằm ở đường Lê Duẩn.' },
  ...
  { id: 53, viet: 'Mấy giờ khởi hành?', zh: '幾點起飛/發車出發？', en: 'What time does it depart?', hanViet: 'Khởi hành (啟行/出發 · 漢越詞)', category: '交通出行', example: 'Chuyến bay của chúng ta mấy giờ khởi hành?' },
  ...
  { id: 55, viet: 'Nhận phòng (Check-in)', zh: '辦理入住登記', en: 'Check-in', hanViet: 'Nhận phòng (入住/登記)', category: '飯店住宿', example: 'Mấy giờ tôi có thể nhận phòng khách sạn?' },
  { id: 56, viet: 'Trả phòng (Check-out)', zh: '辦理退房結帳', en: 'Check-out', hanViet: 'Trả phòng (退房)', category: '飯店住宿', example: 'Giờ trả phòng quy định là 12 giờ trưa.' },
  { id: 57, viet: 'Giữ hành lý giúp tôi', zh: '請幫我寄存行李', en: 'Keep my luggage please', hanViet: 'Hành lý (行李 · 漢越詞)', category: '飯店住宿', example: 'Tôi có thể gửi giữ hành lý ở quầy lễ tân không?' },
  { id: 58, viet: 'Có bao gồm ăn sáng?', zh: '有包含早餐嗎？', en: 'Is breakfast included?', hanViet: 'Bao gồm (包含 · 漢越詞)', category: '飯店住宿', example: 'Giá phòng này đã bao gồm ăn sáng buffet chưa?' },
  { id: 59, viet: 'Mật khẩu Wi-Fi', zh: '無線網路 WiFi 密碼', en: 'Wi-Fi Password', hanViet: 'Mật khẩu (密碼 · 漢越詞)', category: '飯店住宿', example: 'Cho em xin mật khẩu Wi-Fi của quán cà phê.' },
  { id: 60, viet: 'Đổi tiền ở đâu?', zh: '哪裡可以兌換外幣？', en: 'Where can I exchange money?', hanViet: '', category: '飯店住宿', example: 'Ở gần đây có tiệm vàng nào đổi tiền uy tín không?' },
  ...
  { id: 62, viet: 'Vé tham quan', zh: '參觀門票', en: 'Admission ticket', hanViet: 'Tham quan (參觀 · 漢越詞)', category: '旅遊休閒', example: 'Mua vé tham quan Dinh Độc Lập ở đâu?' },
  { id: 63, viet: 'Cảnh đẹp tuyệt vời', zh: '風景極美 / 風光壯麗', en: 'Magnificent scenery', hanViet: 'Cảnh (景) · Tuyệt (絕)', category: '旅遊休閒', example: 'Vịnh Hạ Long có cảnh đẹp tuyệt vời như tranh vẽ.' },
  { id: 64, viet: 'Gội đầu dưỡng sinh', zh: '越式草本養生洗頭', en: 'Herbal hair spa wash', hanViet: 'Dưỡng sinh (養生 · 漢越詞)', category: '生活放鬆', example: 'Đi gội đầu dưỡng sinh thư giãn cuối tuần.' },
  { id: 65, viet: 'Mát-xa toàn thân', zh: '全身指壓按摩', en: 'Full body massage', hanViet: 'Toàn thân (全身 · 漢越詞)', category: '生活放鬆', example: 'Gói mát-xa toàn thân bằng đá nóng 90 phút.' },
  { id: 66, viet: 'Tôi bị đau đầu', zh: '我頭痛', en: 'I have a headache', hanViet: '', category: '醫療健康', example: 'Tôi bị đau đầu và sốt nhẹ từ tối qua.' },
  ...
  { id: 68, viet: 'Tiệm thuốc tây', zh: '西藥房 / 藥局', en: 'Pharmacy / Drugstore', hanViet: 'Tây (西 · 漢越詞)', category: '醫療健康', example: 'Gần đây có tiệm thuốc tây nào mở cửa 24 giờ không?' },
  ...
  { id: 70, viet: 'Cứu tôi với!', zh: '救命！請幫幫我！', en: 'Save me! / Help me!', hanViet: 'Cứu (救 · 漢越詞)', category: '急難求助', example: 'Cứu tôi với, có người bị ngất xỉu!' },
  { id: 71, viet: 'Mất hộ chiếu', zh: '遺失護照', en: 'Lost passport', hanViet: 'Hộ chiếu (護照 · 漢越詞)', category: '急難求助', example: 'Tôi bị mất hộ chiếu, cần đến văn phòng đại diện báo mất.' },
  { id: 72, viet: 'Trạm cảnh sát', zh: '警察派出所', en: 'Police station', hanViet: 'Cảnh sát (警察 · 漢越詞)', category: '急難求助', example: 'Đến trạm cảnh sát gần nhất để làm giấy xác nhận.' },
  { id: 73, viet: 'Giám đốc', zh: '總經理 / 董事長 / 總裁', en: 'Director / CEO', hanViet: 'Giám đốc (總監/監督 · 漢越詞)', category: '商務職場', example: 'Giám đốc công ty chúng tôi đang đi công tác Hà Nội.' },
  { id: 74, viet: 'Nhân viên', zh: '員工 / 職員', en: 'Staff / Employee', hanViet: 'Nhân viên (人員/員工 · 漢越詞)', category: '商務職場', example: 'Nhân viên công ty làm việc rất chuyên nghiệp.' },
  { id: 75, viet: 'Họp bàn kế hoạch', zh: '開會討論計劃', en: 'Meeting to discuss plan', hanViet: 'Kế hoạch (計劃 · 漢越詞)', category: '商務職場', example: 'Sáng nay chúng ta có buổi họp bàn kế hoạch phát triển.' },
  { id: 76, viet: 'Báo cáo tài chính', zh: '財務報表 / 財報', en: 'Financial report', hanViet: 'Báo cáo (報告) · Tài chính (財務)', category: '商務職場', example: 'Nộp báo cáo tài chính quý 3 cho ban giám đốc.' },
  { id: 77, viet: 'Tuyển dụng nhân tài', zh: '徵才招募優秀人才', en: 'Recruit talent', hanViet: 'Tuyển dụng (選用) · Nhân tài (人才)', category: '商務職場', example: 'Doanh nghiệp đang tuyển dụng nhiều nhân tài tiếng Việt.' },
  { id: 78, viet: 'Phát triển thị trường', zh: '拓展開拓市場', en: 'Develop market', hanViet: 'Phát triển (發展) · Thị trường (市場)', category: '商務職場', example: 'Chiến lược phát triển thị trường Đông Nam Á.' },
  { id: 79, viet: 'Đối tác chiến lược', zh: '戰略合作夥伴', en: 'Strategic partner', hanViet: 'Đối tác (對作/夥伴) · Chiến lược (戰略)', category: '商務職場', example: 'Đài Loan là đối tác chiến lược quan trọng của Việt Nam.' },
  { id: 80, viet: 'Đầu tư nước ngoài', zh: '外國投資 (FDI)', en: 'Foreign investment', hanViet: 'Đầu tư (投資 · 漢越詞)', category: '商務職場', example: 'Thu hút nguồn vốn đầu tư nước ngoài vào công nghệ cao.' },
  { id: 81, viet: 'Ký tên đóng dấu', zh: '簽名並蓋章', en: 'Sign and stamp', hanViet: 'Ký tên (簽名 · 漢越詞)', category: '商務職場', example: 'Vui lòng ký tên đóng dấu vào 3 bản hợp đồng.' },
  { id: 82, viet: 'Chúc mừng thành công', zh: '祝賀圓滿成功', en: 'Congratulate success', hanViet: 'Chúc (祝) · Thành công (成功)', category: '商務職場', example: 'Chúc mừng dự án hợp tác thành công rực rỡ!' },
  { id: 83, viet: 'Giao dịch ngân hàng', zh: '銀行臨櫃交易', en: 'Banking transaction', hanViet: 'Giao dịch (交易) · Ngân hàng (銀行)', category: '商務職場', example: 'Thực hiện giao dịch chuyển tiền quốc tế tại ngân hàng.' },
  { id: 84, viet: 'Thuế thu nhập', zh: '個人/企業所得稅', en: 'Income tax', hanViet: 'Thuế (稅) · Thu nhập (收入)', category: '商務職場', example: 'Kê khai thuế thu nhập doanh nghiệp đúng hạn.' },
  { id: 85, viet: 'Bảo hiểm y tế', zh: '全民全民健康保險', en: 'Health insurance', hanViet: 'Bảo hiểm (保險) · Y tế (醫療)', category: '生活保障', example: 'Tất cả người lao động đều được đóng bảo hiểm y tế.' },
  { id: 86, viet: 'Thời tiết hôm nay', zh: '今天天氣狀況', en: 'Today weather', hanViet: 'Thời tiết (時節/氣候 · 漢越詞)', category: '日常對話', example: 'Thời tiết hôm nay ở Đà Nẵng rất mát mẻ và có nắng.' },
  ...
  { id: 88, viet: 'Bao nhiêu tuổi?', zh: '今年幾歲？(年齡)', en: 'How old are you?', hanViet: '', category: '日常對話', example: 'Năm nay em bao nhiêu tuổi rồi?' },
  { id: 89, viet: 'Sở thích của bạn', zh: '你的個人愛好與興趣', en: 'Your hobbies', hanViet: 'Sở thích (所適/嗜好 · 漢越詞)', category: '日常對話', example: 'Sở thích của tôi là nghe nhạc và đi du lịch khám phá.' },
  { id: 90, viet: 'Học tiếng Việt vui lắm', zh: '學越語非常有趣好玩', en: 'Learning Vietnamese is so fun', hanViet: 'Học (學 · 漢越詞)', category: '日常對話', example: 'Học tiếng Việt vui lắm, nhất là phần thanh điệu!' },
  { id: 91, viet: 'Cảm nhận thế nào?', zh: '你覺得感受如何？', en: 'How do you feel about it?', hanViet: 'Cảm nhận (感受/體會 · 漢越詞)', category: '日常對話', example: 'Bạn cảm nhận thế nào về món ăn đường phố Sài Gòn?' },
  ...
  { id: 93, viet: 'Không thành vấn đề', zh: '小事一樁 / 沒問題', en: 'No problem at all', hanViet: 'Vấn đề (問題 · 漢越詞)', category: '道地口語', example: 'Chuyện nhỏ thôi mà, không thành vấn đề đâu.' },
  ...
  { id: 95, viet: 'Trăm phần trăm (100%)', zh: '乾杯！一飲而盡 (100%)', en: 'Bottoms up! / 100%', hanViet: 'Phần trăm (百分比)', category: '道地口語', example: 'Một, hai, ba, dô! Uống trăm phần trăm nhé!' },
  ...
  { id: 97, viet: 'Chúc mừng năm mới', zh: '新年快樂 (過年賀詞)', en: 'Happy New Year', hanViet: 'Chúc (祝 · 漢越詞)', category: '節慶祝福', example: 'Chúc mừng năm mới, an khang thịnh vượng!' },
  { id: 98, viet: 'An khang thịnh vượng', zh: '安康盛旺 (闔家平安、事業興盛)', en: 'Peace and Prosperity', hanViet: 'An khang thịnh vượng (安康盛旺 · 漢越成語)', category: '節慶祝福', example: 'Kính chúc quý công ty năm mới an khang thịnh vượng!' },
  { id: 99, viet: 'Vạn sự như ý', zh: '萬事如意 / 心想事成', en: 'May all your wishes come true', hanViet: 'Vạn sự như ý (萬事如意 · 漢越成語)', category: '節慶祝福', example: 'Năm mới phát tài phát lộc, vạn sự như ý!' },
...
export const quizzes = [
  {
    id: 'q1',
    level: 'A1',
    questionZh: '在越南語六大聲調中，「Thanh Huyền」(玄聲/降調) 的音高走勢特徵是？',
    ...
    answer: 1,
    explanationZh: 'Thanh Huyền 是平緩下降的溫柔低調 (311)，符號為重音符號 ` (Mà)，如 "bà" (奶奶)。',
    explanationEn: 'Thanh Huyền is a gentle low-falling tone (311), marked with a grave accent ` (Mà), e.g. "bà" (grandmother).'
  },
  {
    id: 'q2',
    level: 'A1',
    questionZh: '南越（胡志明市/西貢）口音中，「湯匙」最道地的日常稱呼是？',
    questionEn: 'In Southern Vietnamese (Saigon) dialect, what is the common word for "spoon"?',
    optionsZh: ['Muỗng', 'Thìa', 'Ngô', 'Mũ'],
    optionsEn: ['Muỗng', 'Thìa', 'Ngô', 'Mũ'],
    answer: 0,
    explanationZh: '南越習慣稱湯匙為「Muỗng」，北越（河內）則稱「Thìa」。兩者皆為標準越南語之方言詞彙。',
    explanationEn: 'Southern dialect uses "Muỗng", while Northern dialect uses "Thìa". Both are standard regional vocabulary.'
  },
  {
    id: 'q3',
    level: 'A2',
    questionZh: '數字 25 在越南語中的標準規範讀法是？',
    questionEn: 'What is the correct pronunciation of number 25 in Vietnamese?',
    optionsZh: ['Hai mươi năm', 'Hai mốt', 'Hai mươi lăm', 'Hai lăm mươi'],
    optionsEn: ['Hai mươi năm', 'Hai mốt', 'Hai mươi lăm', 'Hai lăm mươi'],
    answer: 2,
    explanationZh: '在兩位數與多位數中，個位數的 5 若前面有十位數（15-95），必須讀作 "lăm"（如 25 = Hai mươi lăm），以避免與名詞 "năm" (年) 混淆。',
    explanationEn: 'For numbers 15-95, the unit 5 must be pronounced as "lăm" (e.g. 25 = Hai mươi lăm) to distinguish from "năm" (year).'
  },
  {
    id: 'q4',
    level: 'A2',
    ...
    answer: 1,
    explanationZh: '越南語採取「形容詞/修飾語後置」原則：中心名詞 Cà phê (咖啡) + 修飾語 sữa (牛奶) + 修飾語 đá (冰) = 冰牛奶咖啡。',
    explanationEn: 'Vietnamese follows the head-initial rule where modifiers follow the noun: Cà phê (coffee) + sữa (milk) + đá (ice) = Iced Milk Coffee.'
  },
  {
    id: 'q5',
    level: 'B1',
    ...
    optionsZh: ['果 (Fruit)', '過 (Pass)', '鍋 (Pot)', '國 (Country / Nation)'],
    optionsEn: ['Fruit', 'Pass', 'Pot', 'Country / Nation (國)'],
    answer: 3,
    explanationZh: 'Quốc 是漢字「國」的標準漢越音讀（中古入聲 -k 尾轉越語 -c 尾），衍生詞如 Quốc gia (國家)、Quốc tịch (國籍)、Quốc hội (國會)。',
    explanationEn: 'Quốc corresponds to the Chinese character "國" (Nation), forming words like Quốc gia (country), Quốc tịch (nationality).'
  },
  {
    id: 'q6',
    level: 'B2',
    questionZh: '在越南職場中，向比自己年紀稍長、同輩受尊重的男性同事打招呼，最適當的稱呼策略是？',
    questionEn: 'In a Vietnamese workplace, how do you respectfully address a male colleague slightly older than you?',
    optionsZh: ['Chào Anh (自稱 Em)', 'Chào em (自稱 Anh)', 'Chào Bà (自稱 Cháu)', 'Chào Mày (自稱 Tao)'],
    optionsEn: ['Chào Anh (I = Em)', 'Chào em (I = Anh)', 'Chào Bà (I = Cháu)', 'Chào Mày (I = Tao)'],
    answer: 0,
    explanationZh: '面對年齡稍長或初次見面的男性平輩稱呼「Anh」，自己謙稱「Em」，這是越南社會最具教養且專業的商務敬語策略。',
    explanationEn: 'Address slightly older male peers as "Anh" and refer to oneself as "Em", establishing a polite and professional dynamic.'
  },
  {
    id: 'q7',
    level: 'C1',
    questionZh: '在審閱越南商業法規與外商投資合約時，「Điều khoản bất khả kháng」指涉的法律概念是？',
    questionEn: 'In a Vietnamese commercial contract, what legal concept does "Điều khoản bất khả kháng" refer to?',
    optionsZh: ['違約賠償條款 (Liquidated Damages)', '保密協定條款 (NDA)', '不可抗力條款 (Force Majeure)', '管轄法院條款 (Jurisdiction)'],
    optionsEn: ['Liquidated Damages', 'Non-Disclosure Agreement', 'Force Majeure Clause', 'Jurisdiction Clause'],
    answer: 2,
    explanationZh: '「Bất khả kháng」為漢越詞「不可抗」，法律合約中專指因天災、戰爭或政府法令變更等無法預見且不可避免之「不可抗力條款」。',
    explanationEn: '"Bất khả kháng" is the Sino-Vietnamese legal term for Force Majeure, referring to unforeseeable and unavoidable external events.'
  },
  {
    id: 'q8',
    level: 'C1+',
    ...
    answer: 1,
    explanationZh: '「Uống nước nhớ nguồn」(飲水思源) 是越南文化中崇尚孝道與感念師恩的核心美德，常於雄王節（國祖節）、教師節或宗族祭祀時引用。',
    explanationEn: '"Uống nước nhớ nguồn" translates to "When drinking water, remember the source", emphasizing filial piety and gratitude.'
  },
  {
    id: 'q9',
    level: 'C2',
    ...
    optionsZh: ['百年好合與家庭倫理', '商業財富與因果報應', '山水田園與隱逸生活', '才命相妒 / 天妒英才之命運悲劇性'],
    optionsEn: ['Marital bliss and family ethics', 'Wealth and karmic retribution', 'Pastoral and hermit lifestyle', 'The tragic conflict between talent and destiny (才命相妒)'],
    answer: 3,
    explanationZh: '此句意為「百年茫茫人世間，才與命往往相妒相悖」，深刻奠定了《金雲翹傳》乃至越南古典詩歌六八體（Lục bát）探討才華與宿命衝突的哲學母題。',
    explanationEn: 'This opening verse contemplates the tragic conflict between exceptional talent and harsh destiny, the fundamental motif of Vietnamese classical literature.'
  }
];
